...
import top.hyperplasma.hyprojai.entity.vo.Result;
import top.hyperplasma.hyprojai.repository.ChatHistoryRepository;
import top.hyperplasma.hyprojai.repository.FileRepository;
...
public class PdfController {
    ...
    public Flux<String> chat(@RequestBody UserPromptDTO userPromptDTO) {
        ...
        // Depicted - 保存会话ID
        // chatHistoryRepository.save(ServiceType.PDF, chatId);
